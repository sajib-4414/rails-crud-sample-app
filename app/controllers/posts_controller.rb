class PostsController < ApplicationController
  ...
  # in the index file shark_post_path(@shark) generates a url on the runtime
  # as /sharks/1/posts. shark_post_path is generated from the nested
  # resources :sharks do
  #   resources :posts
  # end
  # this path, because of using resources and nested architecture, rails generates
  # paths like this shark_post_path
  def index
    @posts = @shark.posts
  end
